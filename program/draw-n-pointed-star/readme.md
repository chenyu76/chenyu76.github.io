...
在下面的输入框中输入$n_1:m_1, n_2:m_2, \dots$格式的数据来绘制图形， 其中$n_i$是边数，$m_i$是连接间隔，例如输入$5:2$表示在一个圆上逆时针均匀排布5个顶点中，每个顶点连接其后第2个顶点$\pmod 5$。$\max_i n_i$决定绘制的是几角星，剩余的$n_i$控制子图形的连接间隔。

<img src="./pentagram.svg" alt="五角星" style="width:50%;" />
