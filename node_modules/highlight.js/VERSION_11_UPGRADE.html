...
<head>
  ...
  <title>Upgrading to Highlight.js v11.0</title>
...
<body>
  ...
  <div id="title-container">
    ...
    <div id="heading"><h3>node_modules/highlight.js</h3><h1>Upgrading to Highlight.js v11.0</h1></div>
  </div>
...
<h2 id="h2-overview-of-breaking-changes">Overview of Breaking Changes</h2><p>Welcome to version 11.0.  This a major release and therefore contains breaking changes.  Below is a complete list of those such changes.</p>
<h3 id="h3-built-in-set-of-common-languages">Built-in set of "Common" Languages</h3><p>The default <code>highlight.min.js</code> build <strong>removes</strong> a few less popular grammars:</p>
<ul>
<li>apache</li>
<li>http</li>
<li>nginx</li>
...
<h3 id="h3-language-files">Language Files</h3><p>This would matter if you are requiring any of these files directly (via Node.js or CDN).</p>
<ul>
...
<h3 id="h3-language-aliases">Language Aliases</h3><p>This would matter if you are using these aliases.</p>
<ul>
...
<pre><code class="language-js">hljs.<span class="hljs-title function_">registerAliases</span>([<span class="hljs-string">&quot;php3&quot;</span>,<span class="hljs-string">&quot;php4&quot;</span>,<span class="hljs-string">&quot;php5&quot;</span>,<span class="hljs-string">&quot;php6&quot;</span>,<span class="hljs-string">&quot;php7&quot;</span>,<span class="hljs-string">&quot;php8&quot;</span>],{ <span class="hljs-attr">languageName</span>: <span class="hljs-string">&quot;php&quot;</span> })
</code></pre>
<h3 id="h3-styles-and-css">Styles and CSS</h3><ul>
...
<h4 id="h4-grammar-scopes">Grammar Scopes</h4><ul>
...
<pre><code class="language-js"><span class="hljs-comment">// highlight(language, code, ignoreIllegals, continuation)</span>
<span class="hljs-title function_">highlight</span>(<span class="hljs-string">&quot;javascript&quot;</span>, <span class="hljs-string">&quot;var a = 5;&quot;</span>, <span class="hljs-literal">true</span>)
</code></pre>
<p>...would be upgraded to the newer API as follows:</p>
<pre><code class="language-js"><span class="hljs-comment">// highlight(code, {language, ignoreIllegals})</span>
<span class="hljs-title function_">highlight</span>(<span class="hljs-string">&quot;var a = 5;&quot;</span>, {<span class="hljs-attr">language</span>: <span class="hljs-string">&quot;javascript&quot;</span>, <span class="hljs-attr">ignoreIllegals</span>: <span class="hljs-literal">true</span>})
</code></pre>
...
<h5 id="h5-changes-to-result-data">Changes to Result Data</h5><ul>
...
<h4 id="h4-feature-removal">Feature Removal</h4><ul>
...
<p>An example:</p>
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">pre</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">code</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;lang-js&quot;</span>&gt;</span>
var a = 4;
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;yellow&quot;</span>&gt;</span>var a = 4;<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
...
<pre><code class="language-js">{
  <span class="hljs-attr">keywords</span>: <span class="hljs-string">&quot;do.it start.now begin.later end.immediately&quot;</span>
  <span class="hljs-attr">lexemes</span>: <span class="hljs-regexp">/[a-z.]+/</span>
}
</code></pre>
<p>After:</p>
<pre><code class="language-js">{
  <span class="hljs-attr">keywords</span>: {
    <span class="hljs-attr">$pattern</span>: <span class="hljs-regexp">/[a-z.]+/</span>
    <span class="hljs-attr">keyword</span>: <span class="hljs-string">&quot;do.it start.now begin.later end.immediately&quot;</span>,
  }
}
</code></pre>
...
<h3 id="h3-small-things">Small Things</h3><ul>
...
<h3 id="h3-upgrading-from-version-9-x">Upgrading from Version 9.x</h3><p>If you&#39;re upgrading all the way from version 9 it may still be helpful to review all the breaking changes in version 10 as well:</p>
<ul>
...
<ul>
<ul>
<li><a href="#h2-overview-of-breaking-changes">Overview of Breaking Changes</a></li>
<ul>
<li><a href="#h3-built-in-set-of-common-languages">Built-in set of "Common" Languages</a></li>
<li><a href="#h3-language-files">Language Files</a></li>
<li><a href="#h3-language-aliases">Language Aliases</a></li>
<li><a href="#h3-styles-and-css">Styles and CSS</a></li>
<ul>
<li><a href="#h4-grammar-scopes">Grammar Scopes</a></li>
</ul>
<li><a href="#h3-behavioral-changes">Behavioral changes</a></li>
<ul>
<li><a href="#h4-api-changes">API changes</a></li>
<ul>
<li><a href="#h5-changes-to-result-data">Changes to Result Data</a></li>
</ul>
<li><a href="#h4-feature-removal">Feature Removal</a></li>
</ul>
<li><a href="#h3-small-things">Small Things</a></li>
<li><a href="#h3-upgrading-from-version-9-x">Upgrading from Version 9.x</a></li>
</ul>
</ul>
</ul>
</div>
