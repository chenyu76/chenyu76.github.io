...
<h2>Overview of Breaking Changes</h2>
<p>Welcome to version 11.0.  This a major release and therefore contains breaking changes.  Below is a complete list of those such changes.</p>
<h3>Built-in set of &quot;Common&quot; Languages</h3>
<p>The default <code>highlight.min.js</code> build <strong>removes</strong> a few less popular grammars:</p>
<ul>
<li>apache</li>
<li>http</li>
<li>nginx</li>
...
<p>This would matter if you are requiring any of these files directly (via Node.js or CDN).</p>
<ul>
...
<h3>Language Aliases</h3>
<p>This would matter if you are using these aliases.</p>
<ul>
...
<pre><code class="hljs language-js">hljs.<span class="hljs-title function_">registerAliases</span>([<span class="hljs-string">&quot;php3&quot;</span>,<span class="hljs-string">&quot;php4&quot;</span>,<span class="hljs-string">&quot;php5&quot;</span>,<span class="hljs-string">&quot;php6&quot;</span>,<span class="hljs-string">&quot;php7&quot;</span>,<span class="hljs-string">&quot;php8&quot;</span>],{ <span class="hljs-attr">languageName</span>: <span class="hljs-string">&quot;php&quot;</span> })
</code></pre><h3>Styles and CSS</h3>
<ul>
...
<pre><code class="hljs language-js"><span class="hljs-comment">// highlight(language, code, ignoreIllegals, continuation)</span>
...
</code></pre><p>...would be upgraded to the newer API as follows:</p>
<pre><code class="hljs language-js"><span class="hljs-comment">// highlight(code, {language, ignoreIllegals})</span>
...
</code></pre><p>The new API purposely does not support <code>continuation</code> as this is only intended for internal library usage.</p>
<ul>
...
<p>An example:</p>
<pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">pre</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">code</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;lang-js&quot;</span>&gt;</span>
var a = 4;
...
</code></pre><p>Unescaped HTML like this will now be ignored (stripped before highlighting) and a warning will be logged to the console.  All HTML to be highlighted should be properly escaped to avoid potential HTML/JS injection attacks.</p>
<ul>
...
</code></pre><p>This may required converting your <code>keywords</code> key into an object if it&#39;s not already (as shown above).</p>
<ul>
...
<h3>Upgrading from Version 9.x</h3>
<p>If you&#39;re upgrading all the way from version 9 it may still be helpful to review all the breaking changes in version 10 as well:</p>
<ul>
